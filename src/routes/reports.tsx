  ...
  return (
    <AppShell>
      <PageHeader
        ...
        actions={<><Btn variant="secondary">Scheduled (8)</Btn><Btn variant="primary">+ New report</Btn></>}
      />
        ...
        <Card title="Templates">
          <div className="p-4 grid grid-cols-4 gap-3">
            {TEMPLATES.map(([name, desc, cad]) => (
              <div key={name as string} className="border border-border rounded-lg p-4 hover:bg-muted/30 cursor-pointer">
          ...
          <Card title="Custom report builder" hint="Drag blocks · AI can draft narrative">
            <div className="p-4 grid grid-cols-[140px_1fr] gap-3">
              <aside className="space-y-1.5">
                ...
                {["KPI", "Line chart", "Bar chart", "Heatmap", "Map", "Table", "Comp list", "AI narrative ✦", "Audit log"].map((b) => (
                  <div key={b} className="border border-border rounded px-2 py-1.5 text-[12px] bg-surface hover:bg-muted/40 cursor-grab flex items-center gap-1.5">
              ...
              <div className="border border-dashed border-border-strong rounded-md bg-surface-2 p-4 space-y-3 min-h-[400px]">
                <div className="border border-border rounded-md p-3 bg-surface">
                  ...
                  <div className="text-[18px] font-semibold mt-1">Q3 2026 Sunbelt Pricing Decisions</div>
                </div>
                ...
                <div className="border border-border rounded-md p-3 bg-surface">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-[11px] text-muted-foreground">editable · cites sources</span>
                  </div>
                  <p className="text-[12.5px] leading-relaxed">
                    In Q3, RentIQ generated 4,182 pricing recommendations across the Sunbelt portfolio. Analysts approved 86% within tolerance, with the strongest lift in Atlanta Midtown (+4.8% vs baseline)<sup className="text-ai">[1]</sup>. Overrides clustered around 2BR units &gt;1,100 sqft, where comp density is thin<sup className="text-ai">[2]</sup>…
                  </p>
                </div>
          ...
          <div className="space-y-3">
            <Card title="Delivery">
              <div className="p-4 space-y-3 text-[12.5px]">
                ...
                <Btn variant="primary" size="md" className="w-full justify-center">Schedule report</Btn>
              </div>
            </Card>
