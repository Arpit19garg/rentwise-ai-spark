  ...
  return (
    <AppShell>
      <PageHeader
        ...
        subtitle="Users, data sources, model settings, audit"
        actions={<Btn variant="primary">+ Invite user</Btn>}
      />
            ...
            <tbody className="divide-y divide-border">
              {[
                ...
                <tr key={n as string}>
                  ...
                  <td className="px-2">
                    <Chip tone={r === "Data Science" ? "ai" : "neutral"}>{r}</Chip>
                  </td>
                  <td className="px-2 text-muted-foreground">{s}</td>
            ...
            {[
              ...
              <li key={n as string} className="px-4 py-2.5 flex items-center gap-3 text-[12.5px]">
                <div
                  ...
                  style={{
                    background: `var(--${tone === "success" ? "success" : tone === "warning" ? "warning" : tone === "danger" ? "destructive" : "info"})`,
                  }}
                />
